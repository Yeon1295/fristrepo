...
- Of course it is still possible for the DbContext to take control of the connection (just set 
...
- For EF6 and future versions we have taken the approach that if the calling code 
